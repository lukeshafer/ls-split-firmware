...
keyboard.col_pins = (board.GP10,board.GP3, board.GP4, board.GP5, board.GP6, board.GP7, board.GP8)
...
keyboard.keymap = [
    [ # DEFAULT QWERTY
        ...
        KC.BSPC, KC.Z,    KC.X,    KC.C,    KC.V,    KC.B,   KC.VOLU,      KC.PGDN, KC.N,   KC.M,    KC.COMM, KC.DOT,  KC.SLSH, KC.BSLS,
